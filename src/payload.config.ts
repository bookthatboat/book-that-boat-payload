...
export default buildConfig({
  cors: ['http://localhost:3001', 'http://localhost:3000', 'https://book-that-boat-frontend.vercel.app', process.env.PAYLOAD_PUBLIC_SERVER_URL || ''],
  csrf: ['http://localhost:3001', 'http://localhost:3000', 'https://book-that-boat-frontend.vercel.app', process.env.PAYLOAD_PUBLIC_SERVER_URL || ''],
